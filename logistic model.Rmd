...
# Perform Stepwise Selection (both directions: forward and backward) using AIC
...
# Stepwise selection using BIC
bic_model <- stepAIC(full_model, direction = "both", trace = FALSE, k = log(nrow(balance_data)))

# Summary of the final BIC model
summary(bic_model)
